...
<head>
<title>A_Find_Team_Role_Type_Results</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		 ...
		 <h2> <span class="style3"> View All Team Role Type Results  </span> </h2>
		  
		  
		   
		   <iframe width="700" height="550" src="Results.jsp"></iframe>
