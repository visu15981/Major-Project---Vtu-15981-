  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
			 ...
			 <h2 align="center"> <span class="style3"><span class="style3">User</span> <%=request.getParameter("uname")%>'s Profile...</span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <tr>
              ...
              <td  width="158" valign="middle" bgcolor="#9966FF" style="color:#000000;"><div align="left" class="style5" style="margin-left:10px;">
                  <%out.println(s1);%>
              </div></td>
            </tr>
            <tr>
              ...
              <td  width="158" valign="middle" bgcolor="#9966FF" ><div align="left" class="style5 style4" style="margin-left:10px;"><strong>
                  <%out.println(s2);%>
              </strong></div></td>
            </tr>
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#9966FF"><div align="left" class="style5 style4" style="margin-left:10px;"><strong>
                  <%out.println(s5);%>
              </strong></div></td>
            </tr>
            <tr>
              ...
              <td  width="158" align="left" valign="middle" bgcolor="#9966FF"><div align="left" class="style5 style4" style="margin-left:10px;"><strong>
                  <%out.println(s3);%>
              </strong></div></td>
            </tr>
            <tr>
		    ...
		    <tr>
              ...
              <td  width="158" align="left" valign="middle" bgcolor="#9966FF" style="color: #2c83b0;"><div align="left">
                  <div align="left" class="style5 style4" style="margin-left:10px;"><strong>
                    <%out.println(s6);%>
              </strong></div></td>
            </tr>
		 ...
		 <h2 align="right">&nbsp;</h2>
			...
			<%}
			else if(type.equalsIgnoreCase("allfrdimages")){%>
            <h2 align="right"><a href="U_ImageDetail.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("recommended")){%>
            <h2 align="right"><a href="U_ImageDetail.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("allmyimages")){%>
            <h2 align="right"><a href="U_MyImageDetail.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("similarimages")){%>
            <h2 align="right"><a href="U_ImageDetail.jsp?id=<%=id%>&iid=<%=iid%>&name=<%=name%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("allshared")){%>
            <h2 align="right"><a href="U_ImageDetail.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			if(type.equalsIgnoreCase("user2")){%>
            <h2 align="right"><a href="U_AllRecommended.jsp" class="style4">Back</a></h2>
			<%}
			if(type.equalsIgnoreCase("user3")){%>
            <h2 align="right"><a href="U_AllShareImages.jsp" class="style4">Back</a></h2>
			<%}
